...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error 1 ",cursor.moveToFirst());

        TestUtilities.validateCurrentRecord("Error 2 ", cursor,weatherValues);

        assertFalse(" Error 3",cursor.moveToNext());
    ...
    public long insertLocation() {
        ...
        TestUtilities.validateCurrentRecord("Error 2",cursor,contentValues);
